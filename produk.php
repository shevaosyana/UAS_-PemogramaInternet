    ...
    <div class="container">
        <nav class="sidebar">
            ...
            <div class="menu-group">
                ...
                <ul>
                    <li><a href="lokasi.php"><i class="fa fa-location-dot"></i> Lokasi</a></li>
                </ul>
            </div>
            <div class="menu-group">
                <div class="menu-title">Produk</div>
                <ul>
                    <li class="active"><a href="produk.php"><i class="fa fa-bookmark"></i> Produk</a></li>
                </ul>
            </div>
        </nav>
        <main class="main-content">
            <h1>Daftar Produk</h1>
            <p>Halaman ini untuk menampilkan dan mengelola data produk di SMK NEGERI 7 BALEENDAH.</p>
        </main>
    </div>
    <script>
    // Dark mode toggle
